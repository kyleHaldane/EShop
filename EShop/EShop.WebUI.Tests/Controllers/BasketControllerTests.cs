...
namespace EShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void canCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "kyle.haldane@gmail.com", ZipCode = "32826" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("kyle.haldane@gmail.com", "Form"), null);
